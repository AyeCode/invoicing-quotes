...
class WPInv_Quote_Reports {
    ...
    public function quote_actions() {
        if ( is_admin() ) {
            ...
            add_filter( 'wpinv_export_get_columns_quotes', array( $this, 'get_quotes_columns' ) );
    ...
    public function export() {
        ...
        <div class="postbox wpi-export-invoices">
            ...
            <div class="inside">
                ...
                <form id="wpi-export-quotes" class="wpi-export-form" method="post">
    ...
    public function set_quotes_export( $request ) {
        ...
        $this->status       = isset( $request['quote_status'] ) ? sanitize_text_field( $request['quote_status'] ) : 'publish';
    }
    
    public function get_quotes_columns( $columns = array() ) {
        $columns = array(
            'id'            => __( 'ID',   'invoicing' ),
    ...
    public function get_quotes_data( $response = array() ) {
        ...
        $invoices = Wpinv_Quotes_Shared::wpinv_get_invoices( $args );
