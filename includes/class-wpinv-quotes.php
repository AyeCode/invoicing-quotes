...
class Wpinv_Quotes {
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'wp_enqueue_scripts', $plugin_public, 'enqueue_scripts' );
                $this->loader->add_action( 'wp_head', $plugin_public, 'quote_actions', 1 );
	}
...
final class Wpinv_quote_ext {
    ...
    private function setup_invoice( $invoice_id ) {
        ...
        if( 'wpi_quote' !== $invoice->post_type ) {
            return false;
        }
    ...
    public function save( $setup = false ) {
        ...
        do_action( 'wpinv_quote_save', $this, $saved );
    ...
    public function recalculate_total() {
        ...
        do_action( 'wpinv_quote_recalculate_total', $this, $wpi_nosave );
    }
    ...
    public function is_recurring() {
        ...
        return apply_filters( 'wpinv_quote_has_recurring_item', $has_subscription, $this->cart_details );
    }
    ...
    public function is_free_trial() {
        ...
        return apply_filters( 'wpinv_quote_is_free_trial', $is_free_trial, $this->cart_details );
    }
    ...
    public function get_recurring( $object = false ) {
        ...
        if ( $object ) {
            ...
            apply_filters( 'wpinv_quote_get_recurring_item', $item, $this );
        }

        return apply_filters( 'wpinv_quote_get_recurring_item_id', $item, $this );
    }
    ...
    public function get_subscription_name() {
        ...
        return apply_filters( 'wpinv_quote_get_subscription_name', $name, $this );
    }
    ...
    public function is_parent() {
        ...
        return apply_filters( 'wpinv_quote_is_parent', $is_parent, $this );
    }
    
    public function is_renewal() {
        $is_renewal = $this->parent_invoice && $this->parent_invoice != $this->ID ? true : false;

        return apply_filters( 'wpinv_quote_is_renewal', $is_renewal, $this );
    }
    ...
    public function get_subscription_data( $filed = '' ) {
        ...
        return apply_filters( 'wpinv_quote_subscription_data_value', $value, $subscription_meta, $this );
    }
    ...
    public function has_vat() {
        ...
        return apply_filters( 'wpinv_quote_has_vat', $requires_vat, $this );
    }
...
function wpinv_get_quote( $invoice_id = 0, $cart = false ) {
    ...
    $invoice = new Wpinv_quote_ext( $invoice_id );
    return $invoice;
}